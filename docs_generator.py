...
def message_llm(system_prompt, user_prompt, model="gpt-4", temperature=0.7, max_tokens=3000):
    messages = [
...
def summarize_file_gpt3(file_content):
    ...
    summary = message_llm("Please provide a summary of the given code.", prompt, model="gpt-3.5-turbo")
...
def generate_readme_gpt4(summaries):
    ...
    readme_content = message_llm("Please generate detailed documentation for the project.", prompt, model="gpt-4")  # Replace with the actual GPT-4 model name when available
